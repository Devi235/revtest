...
public class TC_162 extends Reuse {

	@Test
	public void tc_162() throws Exception {
		
		report=new ExtentReports(ReportSavingPath+"\\IndependentSearchAddress\\"+"TC_162.html");
		logger =report.startTest("TC_162");
		...
		driver.findElement(By.xpath("//*[text()='OR']")).click();
		 ...
		 {
			 passscreenshot(driver, "ISA-TC_162", "TC-No : 162 - After closing order user is able to place another order by using OR operation");
		 }
		 else
		 {
			 failscreenshot(driver, "ISA-TC_162", "TC-No : 162 - After closing order user is not able to place another order by using OR operation");
		 }
