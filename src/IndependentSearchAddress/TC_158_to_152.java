...
public class TC_158_to_152 extends Reuse {

	@Test
	public void tc_158_to_152() throws Exception {
		
		report=new ExtentReports(ReportSavingPath+"\\IndependentSearchAddress\\"+"TC_158_to_152.html");
		logger =report.startTest("TC_158_to_152");
		...
		try {
			if(driver.findElement(By.xpath("(//*[@class='searchedItem ng-binding ng-scope'])[2]")).isDisplayed())
			 {
				failscreenshot(driver, "ISA-TC_160", "TC-No : 160 - After closing order search variation field is not displaying");
			 }
		} catch (Exception e) {
			
			 passscreenshot(driver, "ISA-TC_160", "TC-No : 160 - After closing order also search variation field is displaying");
		 }
