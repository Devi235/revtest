...
public class TC_36 extends Reuse{
	public ExtentReports report=new ExtentReports(ReportSavingPath+"\\Vieworders\\"+"TC_36.html");
	public ExtentTest logger =report.startTest("TC_36");
	String OrderNo1;
	@Test(priority=0)
	public void OrderNumberGet() throws Exception {
		...
		try{
		 ...
		 waitexplicit(wait);;
		 screenshot(ScreenshotSavingPath+"TC_36");
		 Thread.sleep(7000);
		 logger.log(LogStatus.PASS,"Order saved",logger.addScreenCapture(ScreenshotSavingPath+"TC_36"));
	...
	@Test(priority=1)
	  public void TC_23_24_view() throws Exception {
			...
			screenshot(ScreenshotSavingPath+"TC_36_1");
			 
			if(driver.findElement(By.xpath("(//*[text()='Order number : "+OrderNo1+"'])[1]")).isDisplayed())
			{
				 logger.log(LogStatus.PASS,"OrderNumber display in Vieworders page",logger.addScreenCapture(ScreenshotSavingPath+"TC_36_1"));
			}
			else
			{
				 logger.log(LogStatus.FAIL,"OrderNumber display in Vieworders page",logger.addScreenCapture(ScreenshotSavingPath+"TC_36_1"));
			}
