...
public class TC_44_45 extends Reuse{
	public ExtentReports report=new ExtentReports(ReportSavingPath+"\\Vieworders\\"+"TC_44_45.html");
	public ExtentTest logger =report.startTest("TC_44_45");
	String OrderNo1;
	@Test(priority=0)
	public void OrderNumberGet() throws Exception {
		...
		try{
		 ...
		 Thread.sleep(7000);screenshot(ScreenshotSavingPath+"TC_42_43");
	...
	public void TC_23_24_view() throws Exception {
		...
		if(!driver.findElement(By.xpath("(//*[@class='checkbox'])[1]")).isSelected())//publishn critical
		{
		...
		a.click(details).build().perform();
		 ...
		 {
			 logger.log(LogStatus.PASS,"Details page Critical checkbox published",logger.addScreenCapture(ScreenshotSavingPath+"TC_42_43_2"));
		 }
		 else
		 {
			 logger.log(LogStatus.FAIL,"Details page Critical checkbox published",logger.addScreenCapture(ScreenshotSavingPath+"TC_42_43_2")); 
		 }
	...
	@Test(priority=2)
	public void TC_23_24_view1() throws Exception {
		driver.findElement(By.xpath("(//*[@class='checkbox'])[1]")).click();Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[text()='Save'])[1]")).click();
		String wait1="(//*[text()='Order saved successfully.'])[2]";
		waitexplicit(wait1);;Thread.sleep(5000);	
		
		screenshot(ScreenshotSavingPath+"TC_42_43_2_1");
		logger.log(LogStatus.PASS,"Search results page",logger.addScreenCapture(ScreenshotSavingPath+"TC_42_43_2_1"));
		Actions a=new Actions(driver);
		WebElement details= driver.findElement(By.xpath("(//*[text()='Details'])[1]"));
		a.click(details).build().perform();
		 String wait11="(//*[text()='Cancel'])[1]";
		 waitexplicit(wait11);;Thread.sleep(4000);
		 screenshot(ScreenshotSavingPath+"TC_42_43_4");
		 if(!driver.findElement(By.xpath("//*[@name='checkbox1']")).isSelected())
		 {
			 logger.log(LogStatus.PASS,"Details page Critical checkbox unpublished",logger.addScreenCapture(ScreenshotSavingPath+"TC_42_43_4"));
		 }
		 else
		 {
			 logger.log(LogStatus.FAIL,"Details page Critical checkbox unpublished",logger.addScreenCapture(ScreenshotSavingPath+"TC_42_43_4")); 
		 }
		 driver.findElement(By.xpath("(//*[text()='Cancel'])[1]")).click();
		 String wait111="(//*[@class='circlechart'])[1]";
		 waitexplicit(wait111);;
		 Thread.sleep(5000);
		report.endTest(logger);
		report.flush();    
		driver.close();
